...
/*!**********************************************!*\
  !*** ./src/containers/Home/store/actions.js ***!
  \**********************************************/
/*! exports provided: changeList, getHomeList */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/containers/components/LifeTest/index.js":
/*!*****************************************************!*\
  !*** ./src/containers/components/LifeTest/index.js ***!
  \*****************************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ \"react\");\n/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);\nfunction _typeof(obj) { if (typeof Symbol === \"function\" && typeof Symbol.iterator === \"symbol\") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === \"function\" && obj.constructor === Symbol && obj !== Symbol.prototype ? \"symbol\" : typeof obj; }; } return _typeof(obj); }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\nfunction _possibleConstructorReturn(self, call) { if (call && (_typeof(call) === \"object\" || typeof call === \"function\")) { return call; } return _assertThisInitialized(self); }\n\nfunction _assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError(\"this hasn't been initialised - super() hasn't been called\"); } return self; }\n\nfunction _getPrototypeOf(o) { _getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return _getPrototypeOf(o); }\n\nfunction _inherits(subClass, superClass) { if (typeof superClass !== \"function\" && superClass !== null) { throw new TypeError(\"Super expression must either be null or a function\"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) _setPrototypeOf(subClass, superClass); }\n\nfunction _setPrototypeOf(o, p) { _setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return _setPrototypeOf(o, p); }\n\n\n\nvar LifeTest =\n/*#__PURE__*/\nfunction (_Component) {\n  _inherits(LifeTest, _Component);\n\n  function LifeTest(props) {\n    var _this;\n\n    _classCallCheck(this, LifeTest);\n\n    console.log('constructor');\n    _this = _possibleConstructorReturn(this, _getPrototypeOf(LifeTest).call(this, props));\n    _this.state = {\n      name: 2,\n      age: 9\n    };\n    _this.listRef = react__WEBPACK_IMPORTED_MODULE_0___default.a.createRef();\n    return _this;\n  }\n\n  _createClass(LifeTest, [{\n    key: \"getSnapshotBeforeUpdate\",\n    value: function getSnapshotBeforeUpdate(prevProps, prevState) {\n      //在最近一次渲染输出之前调用,返回值作为componentDidUpdate的第三个参数\n      console.log('getSnapshotBeforeUpdate-----');\n      console.log(prevProps);\n      console.log(this.props);\n      return 89;\n    } // componentWillReceiveProps(nextProps){\n    //   console.log('componentWillReceiveProps');\n    //   // console.log('next');\n    //   // console.log(nextProps);\n    //   // console.log('prev');\n    //   // console.log(this.props);\n    // }\n    // componentWillMount(){\n    //   console.log('componentWillMount');\n    // }\n\n  }, {\n    key: \"componentDidMount\",\n    value: function componentDidMount() {\n      console.log('componentDidMount');\n      var that = this;\n      setTimeout(function () {\n        that.setState({\n          age: 80\n        });\n      }, 1500);\n    }\n  }, {\n    key: \"shouldComponentUpdate\",\n    value: function shouldComponentUpdate(newProps, newState) {\n      // 新的prop,state\n      console.log('shouldComponentUpdate');\n      console.log(newProps);\n      console.log(newState);\n      return true;\n    } // componentWillUpdate(nextProps,nextState){\n    //   console.log('componentWillUpdate');\n    // }\n\n  }, {\n    key: \"componentDidUpdate\",\n    value: function componentDidUpdate(prevProps, prevState, snapshot) {\n      console.log('componentDidUpdate');\n      console.log(snapshot);\n    }\n  }, {\n    key: \"componentWillUnMount\",\n    value: function componentWillUnMount() {\n      console.log('componentWillUnMount');\n    }\n  }, {\n    key: \"componentDidCatch\",\n    value: function componentDidCatch() {\n      console.log('catch error'); //当渲染过程，生命周期，或子组件的构造函数中抛出错误时\n    }\n  }, {\n    key: \"render\",\n    value: function render() {\n      console.log('子组件的rendering');\n      var source = this.props.source;\n      var age = this.state.age;\n      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(\"div\", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(\"h3\", null, JSON.stringify(this.state)), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(\"div\", null, age));\n    }\n  }], [{\n    key: \"getDerivedStateFromProps\",\n    value: function getDerivedStateFromProps(props, state) {\n      console.log('getDerivedStateFromProps');\n      console.log(props);\n      console.log(state); //此方法适用于罕见的用例，即 state 的值在任何时候都取决于 props!!!!!!,但是也单独返回其中的一个state\n\n      return {\n        name: props.source\n      };\n    }\n  }]);\n\n  return LifeTest;\n}(react__WEBPACK_IMPORTED_MODULE_0__[\"Component\"]);\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (LifeTest); //为什么要修改更新生命周期？\n//变更的生命周期 提出一种可被打断的生命周期,而可以被打断的阶段正是实际挂载dom之前的虚拟dom的构建阶段，也就是要被去掉的三个生命周期\n\n//# sourceURL=webpack:///./src/containers/components/LifeTest/index.js?");
